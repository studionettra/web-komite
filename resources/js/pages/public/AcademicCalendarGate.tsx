                ...
                <div className="w-full max-w-md overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-xl shadow-slate-200/50">
                    <div className="bg-blue-600 px-8 py-10 text-center">
                        ...
                        <p className="text-sm leading-relaxed text-blue-100">
                            Kalender akademik dan kurikulum khas ini bersifat terbatas dan hanya
                    ...
                    <div className="p-8">
                        <form onSubmit={submit} className="space-y-6">
                                    ...
                                    <button
                                        ...
                                        className={`block w-full cursor-pointer appearance-none rounded-xl border py-3.5 pr-10 pl-12 text-left shadow-sm transition-all sm:text-sm ${
                                            ...
                                            isDropdownOpen
                                                ...
                                                : 'bg-slate-50/50 hover:border-blue-300 focus:bg-white focus:ring-4'
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        id="student_name"
                                        type="text"
                                        className={`block w-full border py-3.5 pr-4 pl-12 ${errors.student_name ? 'border-red-300 focus:border-red-500 focus:ring-red-500/20' : 'border-slate-200 focus:border-blue-500 focus:ring-blue-500/20'} rounded-xl bg-slate-50/50 shadow-sm transition-all hover:border-blue-300 focus:bg-white focus:ring-4 sm:text-sm`}
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="ml-3 text-sm">
                                    <label htmlFor="agreed" className="text-slate-600">
                                        Saya menyetujui{' '}
                                        <a href="/syarat-dan-ketentuan" target="_blank" className="font-semibold text-blue-600 hover:text-blue-500 hover:underline">
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="flex w-full justify-center rounded-xl border border-transparent bg-blue-600 px-4 py-3.5 text-sm font-bold text-white shadow-md shadow-blue-600/20 transition-all hover:-translate-y-0.5 hover:bg-blue-700 focus:ring-4 focus:ring-blue-500/30 focus:outline-none active:translate-y-0 disabled:cursor-not-allowed disabled:opacity-70 disabled:hover:translate-y-0"
                            >
                                {processing ? (
