                    ...
                    <div className="p-5">
                        <div className="mb-8 rounded-2xl border border-blue-100 bg-blue-50/50 p-5">
                            <div className="flex gap-4">
                                <Info weight="fill" className="mt-0.5 h-6 w-6 shrink-0 text-blue-500" />
                                <div className="text-sm font-medium text-blue-900">
                                    <p className="font-semibold mb-1.5 text-blue-800">Cara Mengatur Google Sheet (Mode Publik):</p>
                                    <ol className="list-decimal ml-5 space-y-1.5 opacity-90">
                        ...
                        <form onSubmit={submit} className="space-y-6">
                            <div>
                                ...
                                <div className="mb-4 grid gap-4 sm:grid-cols-3">
                                        <label
                                            className={`group flex cursor-pointer items-center justify-between rounded-2xl border-2 p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-md ${data.google_spreadsheet_status === 'active' ? 'border-blue-400 bg-blue-50 shadow-sm' : 'border-slate-100 hover:border-blue-200 bg-white'}`}
                                        >
                                            <div className="flex w-full items-center justify-between">
                                                <div className="flex flex-col gap-2">
                                                    ...
                                                    <span className="pl-8 text-xs font-medium text-slate-500">Laporan kas besar (global) dapat dilihat publik.</span>
                                                </div>
                                            </div>
                                        </label>
                                        <label
                                            className={`group flex cursor-pointer items-center justify-between rounded-2xl border-2 p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-md ${data.google_spreadsheet_status === 'preparing' ? 'border-amber-400 bg-amber-50 shadow-sm' : 'border-slate-100 hover:border-amber-200 bg-white'}`}
                                        >
                                            <div className="flex w-full items-center justify-between">
                                                <div className="flex flex-col gap-2">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        />
                                                        <span className="text-sm font-semibold text-slate-800 group-hover:text-amber-500 transition-colors">
                                                            Sedang Disiapkan
                                                        </span>
                                                    </div>
                                                    <span className="pl-8 text-xs font-medium text-slate-500">Menampilkan pesan bahwa admin sedang menyusun laporan ini.</span>
                                                </div>
                                            </div>
                                        </label>
                                        <label
                                            className={`group flex cursor-pointer items-center justify-between rounded-2xl border-2 p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-md ${data.google_spreadsheet_status === 'hidden' ? 'border-slate-400 bg-slate-50 shadow-sm' : 'border-slate-100 hover:border-slate-300 bg-white'}`}
                                        >
                                            <div className="flex w-full items-center justify-between">
                                                <div className="flex flex-col gap-2">
                                                    <div className="flex items-center gap-3">
                                                    ...
                                                    <span className="pl-8 text-xs font-medium text-slate-500">Laporan disembunyikan / offline dari halaman publik.</span>
                                                </div>
                                            </div>
                                        </label>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative mt-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full rounded-2xl border-2 border-slate-100 bg-slate-50 py-3.5 pr-4 pl-12 font-medium transition-all hover:bg-white focus:border-blue-400 focus:bg-white focus:ring-4 focus:ring-blue-400/20 outline-none"
